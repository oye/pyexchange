...
class BaseExchangeCalendarEvent(object):
  ...
  DATA_ATTRIBUTES = [u'_id', u'subject', u'start', u'end', u'location' u'is_response_requested', u'html_body', u'text_body', u'organizer', u'_attendees', u'_resources']
